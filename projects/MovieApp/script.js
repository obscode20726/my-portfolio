...
const API_KEY = 'api_key=9f6abdb080285c3672e068f21beb9a85';
        ...
        <div class="col">
          <div class="card">
            <a class="card-media" href="./img-01.jpeg">
              <img src="${poster_path? IMG_URL+poster_path: "http://via.placeholder.com/1080x1580" }" alt="${title} width="100%" />
            </a>

            <div class="card-content">
              <div class="card-cont-header">
                <div class="cont-left">
                  <h3 style=" color: #eee">${movie.original_title}</h3>
                  <span style="color: #12efec">${movie.release_date}</span>
                  <span class="${getColor(vote_average)}">${vote_average}</span>
                </div>
                <div class="cont-right">
                
                <button class="btn" target="_blank" id="${id}">Know More</button>
                </div>
              </div>
...
const showResults = (items) => {
  let content = !inSearchPage ? main.innerHTML : ""
